...
<form method="post" action="./menu.php?page=rule">
...
<td align="center"><a href="./menu.php?page=rule&id_transaksi=<?php echo $row_rule[id_transaksi]; ?>&aksi=del&id_penyakit=<?php echo $id_penyakit; ?>&id_gejala=<?php echo $row_rule[id_gejala]; ?>" onClick="return confirmdelete('Data ini');">Delete</a></td>
</tr>
<?php
}
?>
