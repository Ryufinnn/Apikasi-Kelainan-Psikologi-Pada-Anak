...
<body>
<a href="menu.php?page=gejala&aksi=add">Tambah</a>
...
<form method="post" action="insert_gejala.php">
  ...
  <td width="50" align="center"><input type="button" value=" Batal " onclick="parent.location='menu.php?page=gejala'" /></td>
</form>
</tr>
<?php
}
...
<tr bgcolor="<?php echo $warna; ?>">
  ...
  <td width="50" align="center"><a href="menu.php?page=gejala&aksi=edit&id=<?php echo $row[id]; ?>">Edit</a></td>
  <td width="50" align="center"><a href="menu.php?page=gejala&aksi=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');">Delete</a></td>
</tr>
<?php
}
