...
<body>
<a href="menu.php?page=penyakit&amp;aksi=add">Tambah</a>
...
<form method="post" action="insert_penyakit.php">
  ...
  <td width="50" align="center"><input type="button" value=" Batal " onclick="parent.location='menu.php?page=penyakit'" /></td>
</form>
</tr>
<?php
}
...
<tr bgcolor="<?php echo $warna; ?>">
  ...
  <td width="50" align="center" ><a href="menu.php?page=penyakit&aksi=edit&id=<?php echo $row[id]; ?>">Edit  |</a></td>
  <td width="50" align="center"><a href="menu.php?page=penyakit&aksi=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');">Delete</a></td>
</tr>
<?php
}
